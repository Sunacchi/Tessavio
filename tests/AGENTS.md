...
- Integration: webhook/Queue/D1, reminder Cron/delivery, provider mocks, OAuth and later Google export.
- Security: cross-user read/write denial, role denial, forged/reused callback, duplicate update, and secret-log scanning.
